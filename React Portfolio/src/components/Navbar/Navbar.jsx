    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav ms-auto me-auto pt-2">
       ...
       <div className="icon-nav mx-2">
            <ul>
                <li><a href="https://www.linkedin.com" target="_blank"><i className="fa fa-linkedin mx-2"></i></a></li>
                <li><a href="https://www.github.com" target="_blank"><i className="fa fa-github mx-2"></i></a></li>
