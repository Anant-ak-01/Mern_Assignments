...
<div className="main-card">
   <h1 className='fw-bold mb-4 mt-4 ms-5'>Technical <span style={{color:"#8D72FF",borderBottom:'2px groove #8D72FF'}}>Skills</span></h1>
   {
    data.map((section,index)=>{
      return (
      <div key={index}>  <h2 className='fw-bold mb-lg-5  mt-lg-5 text-center '>{section.title} 
